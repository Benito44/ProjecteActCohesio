...
-- Schema activitats_cohesio
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `activitats_cohesio` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci;
...
CREATE TABLE IF NOT EXISTS `activitats_cohesio`.`alumne` (
  ...
  CONSTRAINT `fk_usuari_grup` FOREIGN KEY (`grup_id`) REFERENCES `activitats_cohesio`.`grup` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `activitats_cohesio`.`activitat` (
  ...
  CONSTRAINT `fk_activitat_professor1` FOREIGN KEY (`professor_puntuador`) REFERENCES `activitats_cohesio`.`professor` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_activitat_professor2` FOREIGN KEY (`professor_assistencia`) REFERENCES `activitats_cohesio`.`professor` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `activitats_cohesio`.`alumne_assisteix_activitat` (
  ...
  CONSTRAINT `fk_alumne_has_activitat_alumne1` FOREIGN KEY (`alumne_id`) REFERENCES `activitats_cohesio`.`alumne` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_alumne_has_activitat_activitat1` FOREIGN KEY (`activitat_id`) REFERENCES `activitats_cohesio`.`activitat` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `activitats_cohesio`.`grup_puntua_activitat` (
  ...
  CONSTRAINT `fk_grup_has_activitat_grup1` FOREIGN KEY (`grup_id`) REFERENCES `activitats_cohesio`.`grup` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_grup_has_activitat_activitat1` FOREIGN KEY (`activitat_id`) REFERENCES `activitats_cohesio`.`activitat` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
